...
class MarzbanServer(models.Model):
...
class MarzbanServerKey(models.Model):
    server = models.ForeignKey(
        MarzbanServer, on_delete=models.CASCADE, related_name='keys')
    ...
    config = models.CharField(max_length=2000, default='', blank=True)
    data_limit = models.BigIntegerField(default=0, verbose_name=_(
        'Data limit (MB)'), help_text=_('Use 0 for unlimited data'))
